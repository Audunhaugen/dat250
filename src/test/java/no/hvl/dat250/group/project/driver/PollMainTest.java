...
public class PollMainTest {

    private EntityManagerFactory factory;

//    @Before
//    public void setUp() {
//        factory = Persistence.createEntityManagerFactory(PollMain.PERSISTENCE_UNIT_NAME);
//    }

//    @Test
//    public void testDomainModelPersistence() {
//        // Run the main class to persist the objects.
//        PollMain.main(new String[]{});
//
//        EntityManager em = factory.createEntityManager();
//
//        // Load customer
//        User customer = em.find(User.class, 1L);
//
//        // Test person data
...
//        Result address = customer.getAddresses().iterator().next();
//
...
//        Poll firstCard = getCardWithNumber(customer, 12345);
//        Poll secondCard = getCardWithNumber(customer, 123);
//
...
//
//        // Test pincode
//        Answer firstCardPincode = firstCard.getPincode();
//
...
//    private Poll getCardWithNumber(User customer, int cardNumber) {
//        Optional<Poll> optionalCard = customer.getCreditCards().stream()
